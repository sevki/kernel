 ...
 * mapper device has no table (and thus no name). Once a table has been established if the name of
 * the device is one of the three restricted ones any future mknod will be rejected with -EPERM.
 *
